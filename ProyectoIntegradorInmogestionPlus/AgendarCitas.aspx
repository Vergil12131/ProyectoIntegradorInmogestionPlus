<%@ Page Title="" Language="C#" MasterPageFile="~/Avisos.MASTER" AutoEventWireup="true" CodeBehind="AgendarCitas.aspx.cs" Inherits="ProyectoIntegradorInmogestionPlus.AgendarCitas" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cph_contenido" runat="server">
    <asp:UpdatePanel runat="server">
        <ContentTemplate>
            ...
            <div class="container">
                ...
                <div class="form-container">
                    ...
                    <div class="form-group">
                        <asp:HiddenField ID="hfComentarioAgente" runat="server" />
                  ...
                  <%--  <div class="form-group" visible="false">
                        ...
                        <asp:TextBox ID="txtDescripcion" runat="server" placeholder="Descripción" CssClass="form-control" TextMode="MultiLine" Rows="5"></asp:TextBox>
            ...
            <div class="gridview-container" style="display:none;">
