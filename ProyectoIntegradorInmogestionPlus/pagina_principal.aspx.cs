...
namespace ProyectoIntegradorInmogestionPlus
{
    public partial class pagina_principal : System.Web.UI.Page
    {
        ...
        private void CargarDdlTipoInmueble()
        {
            var tipo = tinm.ListarInmueblees();

            ddlTipoInmueble.DataSource = tipo;
            ddlTipoInmueble.DataValueField = "tinm_id";
            ddlTipoInmueble.DataTextField = "tinm_nombre";
        ...
        {
            Session["filtroDireccion"] = txtDireccion.Text;
            Session["filtroAccion"] = hfAccionBusqueda.Value;
            Session["filtroTipoInmueble"] = ddlTipoInmueble.SelectedItem.Text;
            Response.Redirect("Vista_Propiedades.aspx");
        }

        protected void btnComprar_Click(object sender, EventArgs e)
        {
            btnAlquilar.Attributes.Remove("class");
            btnComprar.Attributes.Remove("class");
            btnAlquilar.Attributes.Add("class", "nav-link");
            btnComprar.Attributes.Add("class", "nav-link active");

            hfAccionBusqueda.Value = "Comprar";
        }
        ...
        protected void btnAlquilar_Click(object sender, EventArgs e)
        {
            btnAlquilar.Attributes.Remove("class");
            btnComprar.Attributes.Remove("class");
            btnAlquilar.Attributes.Add("class", "nav-link active");
            btnComprar.Attributes.Add("class", "nav-link");

            hfAccionBusqueda.Value = "Alquilar";
        }
    }
}