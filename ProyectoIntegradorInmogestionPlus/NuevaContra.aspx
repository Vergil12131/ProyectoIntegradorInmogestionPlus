<%@ Page Title="" Language="C#" MasterPageFile="~/NuevaContra.Master" AutoEventWireup="true" CodeBehind="NuevaContra.aspx.cs" Inherits="ProyectoIntegradorInmogestionPlus.NuevaContra1" %>
        ...
        <ContentTemplate>
            ...
            <table style="width: 95%">
                <caption>
                    ...
                    <tr>
                        <td class="text-start">
                            <asp:Label ID="lbl_error_contraseña" CssClass="labels" runat="server" style="display:none"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td class="auto-style2">
                            <asp:Label ID="lbl_error_segunda_contra" CssClass="labels"  runat="server" Text="Label" style="display:none" ></asp:Label>
                        </td>
                    </tr>
                    <tr>
