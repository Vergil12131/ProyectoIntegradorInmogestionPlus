<%@ Page Title="" Language="C#" MasterPageFile="~/Publicacion2.Master" AutoEventWireup="true" CodeBehind="publicacion2_definitivo.aspx.cs" Inherits="ProyectoIntegradorInmogestionPlus.publicacion2_definitivo" %>
                        ...
                        <div class="col-md-12">
                            ...
                            <script>
                                function initializeMap() {
                                    ...
                                    // Agregar una capa de mapa usando OSM tiles
                                    ...
                                    map.on('geosearch/showlocation', function () {
                                        ...
                                        map.eachLayer(item => {
                                            if (item instanceof L.Marker) {
                                                ...
                                                // Manejar el evento 'dragend' del marcador de búsqueda
