<%@ Page Title="" Language="C#" MasterPageFile="~/RecuperarContra.Master" AutoEventWireup="true" CodeBehind="RecuperarContra.aspx.cs" Inherits="ProyectoIntegradorInmogestionPlus.RecuperarContra1" %>
        ...
        <ContentTemplate>
            ...
            <table style="width: 95%">
                <caption>
                    ...
                    <tr>
                        <td class="text-left">
                            <asp:TextBox ID="txtRecuperar" runat="server" CssClass="custom-textbox"></asp:TextBox>
                        </td>
                    </tr>
                    <tr class="text-start">
                        <td>
                            <asp:Label ID="lbl_error_recuperarcontra" runat="server" Text=""  ForeColor="Red"></asp:Label>
                        </td>
                    </tr>
                    <tr>
