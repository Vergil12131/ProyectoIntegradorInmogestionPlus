<%@ Page Title="" Language="C#" MasterPageFile="~/Codigo.Master" AutoEventWireup="true" CodeBehind="Codigo.aspx.cs" Inherits="ProyectoIntegradorInmogestionPlus.Codigo1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph_contenido" runat="server">
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <div class="text-with-margin">Ingrese el código enviado al correo</div>
             <asp:TextBox ID="txtv_verificar" runat="server" TextMode="Number" CssClass="custom-textbox"></asp:TextBox>
