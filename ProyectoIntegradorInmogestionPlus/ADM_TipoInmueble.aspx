<%@ Page Title="" Language="C#" MasterPageFile="~/Mantenimiento.Master" AutoEventWireup="true" CodeBehind="ADM_TipoInmueble.aspx.cs" Inherits="ProyectoIntegradorInmogestionPlus.ADM_TipoInmueble" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Gestionar tipo Inmueble</title>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server">
    ...
    <div class="sidebar">
        ...
        <a href="ADM_TipoInmueble.aspx">
            <img src="/source/images/mantenimiento/Imagenes/Gestion_Tinmueble.png" alt="Gestionar Propiedades" class="sidebar-icon" />
            Gestionar Tipo inmueble</a>
    ...
    <div class="content">
        <h2>Gestionar tipo de inmueble</h2>
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                <asp:HiddenField ID="hiddenFieldId" runat="server" />
                <div class="container">
                    <div class="form-group">
                        <label for="tipo inmueble">Ingrese el tipo inmueble</label>
                        <asp:TextBox ID="txt_TipoInmueble" runat="server" CssClass="form-control" placeholder="tipo inmueble"></asp:TextBox>
                    ...
                    <asp:GridView ID="GridView1" runat="server" CssClass="table table-bordered" AutoGenerateColumns="False">
                        <Columns>
                            <asp:BoundField DataField="tinm_id" HeaderText="Codigo" />
                            <asp:BoundField DataField="tinm_nombre" HeaderText="Tipo inmueble" />
                            <asp:TemplateField HeaderText="">
                                <ItemTemplate>
                                    <asp:Button ID="btnSeleccion" Text="Seleccione" CommandArgument='<%#Eval ("tinm_id") %>' CssClass="btn btn-primary" runat="server" OnClick="btnSeleccion_Click" />
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                    </asp:GridView>
